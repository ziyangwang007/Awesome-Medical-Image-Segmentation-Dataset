...
- [Head and Neck Tumor Segmentation in PET/CT: The HECKTOR Challenge](https://hecktor.grand-challenge.org/)
- [Fast and Low-resource semi-supervised Abdominal oRgan sEgmentation in CT （FLARE 2022](https://flare22.grand-challenge.org/)
- [3D Teeth Scan Segmentation and Labeling Challenge](https://3dteethseg.grand-challenge.org/)
- [CarOtid vessel wall SegMentation and atherosclerOsis diagnosiS challenge (COSMOS 2022)](https://vessel-wall-segmentation-2022.grand-challenge.o)
...
- [Micro-Net: Fluorescence Cell Segmentation Dataset](https://warwick.ac.uk/fac/cross_fac/tia/data/micronet)
- [HoVer-Net: Simultaneous Segmentation and Classification of Nuclei in Multi-Tissue Histology Images](https://warwick.ac.uk/fac/cross_fac/tia/data/hovernet/)
...
- [xVertSeg - Segmentation and Classification of Fractured Vertebrae](http://lit.fe.uni-lj.si/xVertSeg/)
